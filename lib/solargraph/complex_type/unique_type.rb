...
module Solargraph
  class ComplexType
    ...
    class UniqueType
      ...
      # Flow-sensitive type narrowing. A single type narrows exactly
      # as a one-item union does, so this defers to ComplexType rather
      # than keeping a second copy of the rules.
      #
      # @see ComplexType#narrow_with
      #
      ...
      def narrow_with narrowing_type, api_map
        ...
        ComplexType.new([self]).narrow_with(narrowing_type, api_map)
      end
